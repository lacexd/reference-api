...
class APIController {
    constructor(registry, opts = {}) {
        ...
        this.handle = (request, serverReq, serverRes, opts = {}) => __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const resultBuildingOpts = Object.assign({}, transformExtras, { makeDocument: this.makeDoc, transformDocument: R.partialRight(transformDoc, [transformExtras]), makeQuery: this.makeQuery, setTypePaths: R.partialRight(set_type_paths_1.default, [transformExtras.registry]) });
    ...
    finalizeRequest(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const guardedQueryParamParse = (parser, paramName) => {
                try {
                    return parser(finalizedSupportedOperators[paramName], request.rawQueryString, request.queryParams);
                }
                catch (e) {
            ...
            const finalizedRequest = Object.assign({}, request, { queryParams: Object.assign({}, parse_query_params_1.default(request.queryParams), { filter: guardedQueryParamParse(this.filterParamParser, "filter"), sort: guardedQueryParamParse(this.sortParamParser, "sort") }), document: undefined });
    ...
    getFinalizedSupportedOperators(adapter) {
        ...
        const ASSUMED_BINARY_OPERATORS = ["eq", "neq", 'ne', "in", "nin", 'lt', 'gt', 'lte', 'gte'];
        const res = Object.keys(supportedOperators).reduce((acc, operatorName) => {
            ...
            const operatorConfig = Object.assign({}, supportedOperators[operatorName]);
            ...
            if (!supportedOperators[operatorName].finalizeArgs) {
                operatorConfig.finalizeArgs = parse_query_params_1.finalizeFilterFieldExprArgs;
            }
            legalIn.forEach(key => {
    ...
    makeResult(opts, customQueryFactory) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = yield adapter.doQuery(query).then(query.returning, query.catch);
...
function transformDoc(doc, mode, extras) {
    return __awaiter(this, void 0, void 0, function* () {
        const transformLinkage = extras.registry.typeNames().some(it => extras.registry.transformLinkage(it));
        return doc.transform(make_transform_fn_1.default(mode, extras), !transformLinkage);
    });
}
